import{_ as n}from"./plugin-vue_export-helper.21dcd24c.js";import{o as s,c as a,e}from"./app.82c47ead.js";const t={},l=e(`<p>In the browser, if there are too many pages, there will be two scroll bars, horizontal and vertical, the default style is ugly, you can adjust it according to the style of the page.</p><h2 id="_1-cancel-scroll-bar" tabindex="-1"><a class="header-anchor" href="#_1-cancel-scroll-bar" aria-hidden="true">#</a> 1 Cancel Scroll Bar</h2><p>You can cancel the scroll bar display in the following two ways:</p><h3 id="_1-1-use-overflow-inside-css-to-unscroll" tabindex="-1"><a class="header-anchor" href="#_1-1-use-overflow-inside-css-to-unscroll" aria-hidden="true">#</a> 1.1 Use Overflow Inside CSS to Unscroll</h3><div class="language-css ext-css line-numbers-mode"><pre class="language-css"><code><span class="token selector">&lt;style&gt;
